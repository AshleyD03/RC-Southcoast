...
class Player {
    constructor (params) {
        ...
        this.PenaltyBoard = new PenaltyBoard({Player: this,});
        this.Settings = new PlayerSettings({Player: this,});
        this.FlagRecorder = flagRecorder({Player: this,});
    ...
    _delete_ () {
        // Remove elements with eventlisteners linked only to player modules
...
class Session {
    ...
    removePlayer (id) {
        if (this._isMultiplayer === false) return false
